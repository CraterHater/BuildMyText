...
public class Text {
	...
	public static List<Block> getAllAffectedBlocks(BufferedImage image, Location location, BlockFace direction, int thickness, boolean underline, Halign halign, Valign valign){
